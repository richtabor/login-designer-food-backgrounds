...
if ( ! class_exists( 'Login_Designer_Food_Backgrounds' ) ) :
	...
	final class Login_Designer_Food_Backgrounds {
		 ...
		 * @uses Login_Designer_Food_Backgrounds::setup_constants() Setup the constants needed.
		 * @uses Login_Designer_Food_Backgrounds::includes() Include the required files.
		...
		private function includes() {
			require_once LOGIN_DESIGNER_FOOD_BACKGROUNDS_PLUGIN_DIR . 'includes/class-login-designer-food-backgrounds-notice.php';
		}
